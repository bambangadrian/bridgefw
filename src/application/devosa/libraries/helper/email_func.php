...
doInclude('plugins/phpmailer/class.phpmailer.php');
doInclude('plugins/phpmailer/class.smtp.php');
doInclude('plugins/phpmailer/PHPMailerAutoload.php');
$db = new CdbClass;
$db->connect();
$employeeID = "";
$module_permission = "";
...
function sendMail($subject, $body, $cc, $altBody)
{
    ...
    $mail->Host = 'mail.invosa.com'; // Specify main and backup SMTP servers
