...
class Inflector
{
    ...
    function __initPluralRules()
    {
        ...
        $corePluralRules = [
            ...
            # alias
            '/(octop|vir)us$/i'          => '\1i',
            # octopus, virus - virus has no defined plural (according to Latin/dictionary.com), but viri is better than viruses/viruss
        ...
        $_this->pluralRules = ['pluralRules' => $pluralRules, 'uninflected' => $uninflected, 'irregular' => $irregular];
        $_this->pluralized = [];
    }
