...
class clsTbsExcel
{
    ...
    function OnInstall()
    {
        ...
        return ['OnCommand', 'BeforeLoadTemplate', 'AfterShow', 'OnOperation', 'BeforeMergeBlock', 'AfterMergeBlock'];
    }
    ...
    function BeforeLoadTemplate(&$File, &$HtmlCharSet)
    {
        ...
        if ($HtmlCharSet === '') {
            $HtmlCharSet = '=clsTbsExcel.f_XmlConv';
        }
    }
