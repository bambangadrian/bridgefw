    ...
    */
    ...
    if ($bolOK) { // input OK, tinggal disimpan
        ...
        if ($strDataID == "") {
            ...
            $strSQL .= "payment_from, payment_thru) ";
            ...
            $strSQL .= "(date '$strDateStart' + interval '" . ($strDataPeriode - 1) . "  month'))";
            ...
            $strSQL .= "payment_thru = (date '$strDateStart' + interval '" . ($strDataPeriode - 1) . " month') ";
...
if ($db->connect()) {
    ...
    $strInputPODate = "<input class=\"form-control datepicker\" data-date-format=\"yyyy-mm-dd\" type=text size=15 maxlength=10 name=dataPODate id=dataPODate value=\"" . $arrData['dataPODate'] . "\">";
