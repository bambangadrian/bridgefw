...
$strDataDetail = "<tr align='center' valign='middle' class='tableHeader'>  <td width='10' rowspan='2'>&nbsp;</td> <td width='10' rowspan='2'>&nbsp;</td> <td rowspan='2'>&nbsp;" . $strWordsID . "&nbsp;</td> <td nowrap rowspan='2'>&nbsp;" . $strWordsEmployeeName . "&nbsp;</td>" ./* <td colspan='2'>&nbsp;".$strWordsEarlyPlan."&nbsp; </td><td colspan='2'>&nbsp;".$strWordsEarlyAuto."&nbsp; </td>*/
    ...
    "<td align='center' valign='middle'>" . $strWordsStart . "</td> <td align='center' valign='middle'>" . $strWordsFinish . "</td><td align='center' valign='middle'>" . $strWordsStart . "</td> <td align='center' valign='middle'>" . $strWordsFinish . "</td></tr>";
$strDetailFooter = "<tr class='tableHeader'><td>&nbsp;</td><td><input name='chkAll' type='checkbox' id='chkAll' value='checkbox' onClick='checkAll();'></td><td colspan=2 nowrap align='left'>&nbsp;</td>" ./*<td colspan=2><input name='btnDefaultEarly' type='button' id='btnDefaultEarly' value='Use Default' onClick='checkDefaultEarly();'>*/
    "</td><td colspan=2 nowrap align='left'>&nbsp;</td><td colspan=2><input name='btnDefaultAfternoon' type='button' id='btnDefaultAfternoon' value='Use Default' onClick='checkDefaultAfternoon();'></td><td colspan=9>&nbsp;</td> </tr>";
//----------------------------------------------------------------------
//--- DAFTAR FUNSI------------------------------------------------------
