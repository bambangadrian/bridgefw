...
function getData($db, &$intRows, $strKriteria = "", $strOrder = "")
{
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
        ...
        $strResult .= "		<label class=\"col-sm-3 control-label\" for=\"dataType\">" . $words['subject'] . "</label>";
        $strResult .= " 	<div class=\"col-sm-9\"><input class=\"form-control\" type=text maxlength=127 name=detailSubject$intRows value=\"" . $rowDb['subject'] . "\"></div>";
        $strResult .= "	</div>\n";
        $strResult .= "	<div class=\"form-group\">";
        ...
        $strResult .= "  	<input type=text class=\"form-control\" maxlength=63 name=detailInstitution$intRows value=\"" . $rowDb['institution'] . "\"></div>";
        $strResult .= "	</div>\n";
        /*$strResult .= "	<div class=\"form-group\">";
        $strResult .= "  <label class=\"col-sm-3 control-label\" for=\"dataType\">" .$words['trainer']."</label>";
        $strResult .= "  <div class=\"col-sm-9\"><input type=text class=\"form-control\" maxlength=63 name=detailTrainer$intRows value=\"" .$rowDb['trainer']. "\"></div>";
        $strResult .= "	</div>\n";*/
        $strResult .= "	<div class=\"form-group\">";
        $strResult .= "  <label class=\"col-sm-3 control-label\" for=\"dataType\">" . $words['location'] . "</label>";
        $strResult .= "  <div class=\"col-sm-9\"><input type=text class=\"form-control\" maxlength=31 name=detailLocation$intRows value=\"" . $rowDb['location'] . "\"></div>";
        $strResult .= "	</div>\n";
        $strResult .= "</div>\n";
        $strResult .= "<div class=\"col-md-4\">\n";
        $strResult .= "	<div class=\"form-group\">";
        ...
        $strResult .= "	<div class=\"form-group\">";
        $strResult .= "  <label class=\"col-sm-3 control-label\" for=\"dataType\">" . $words['certificate'] . "</label>";
        $strResult .= "  <div class=\"col-sm-9\"><div class=\"checkbox\"><label><input class=\"checkbox-inline\" type=checkbox name=detailCertificate$intRows value=\"" . $rowDb['id'] . "\" $strCheck></label></div></div>\n";
        $strResult .= "	</div>\n";
        $strResult .= "</div>\n";
        $strResult .= "<div class=\"col-md-4\">\n";
        $strResult .= "	<div class=\"form-group\">";
        $strResult .= "  <label class=\"col-sm-3 control-label\" for=\"dataType\">" . $words['note'] . "</label>";
        $strResult .= "  <div class=\"col-sm-9\"><textarea class=\"form-control\"  cols=$intDefaultWidth rows=2 name=detailNote$intRows >" . $rowDb['note'] . "</textarea></div>";
        $strResult .= "	</div>\n";
...
$strPageDesc = getWords("employee training information");
...
$pageSubMenu = employeeEditSubmenu($strWordsTrainingData);
