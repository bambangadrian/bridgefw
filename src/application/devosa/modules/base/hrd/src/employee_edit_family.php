...
function getData($db, &$intRows, $strKriteria = "", $strOrder = "")
{
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
        ...
        $strResult .= "  <td nowrap><div class=\"input-group\"><input type=text class=\"form-control datepicker\" maxlength=10 name=detailBirthday$intRows id=\"detailBirthday$intRows\" value=\"" . $rowDb['birthday'] . "\" data-date-format=\"yyyy-mm-dd\">";
    ...
    for ($i = 1; $i <= $intAdd; $i++) {
        ...
        $strResult .= "  <td nowrap><div class=\"input-group\"><input type=text class=\"form-control datepicker\" maxlength=10 name=detailBirthday$intRows id=\"detailBirthday$intRows\" value=$strNow data-date-format=\"yyyy-mm-dd\">&nbsp;";
        $strResult .= "<span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span></div></td>";
