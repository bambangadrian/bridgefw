...
$strWordsBranch = getWords("location");
...
$strWordsGrossUp = getWords("gross up");
...
function createTempData($db, $strDataID)
{
    ...
    $strFields .= "functional_code, zakat, gross_up,get_jamsostek,get_bpjs, is_immune_auto_alpha";
...
function getData($db, &$arrData)
{
    ...
    if ($strDataID == "") {
        ...
        $strSQL = "SELECT *,to_char(birthday,'MM/DD/YYYY') As birthday_,
      to_char(join_date,'MM/DD/YYYY') As join_date_,
      to_char(due_date,'MM/DD/YYYY') As due_date_,
      to_char(resign_date,'MM/DD/YYYY') As resign_date_ ,
      to_char(wedding_date,'MM/DD/YYYY') As wedding_date_ FROM hrd_employee ";
        $strSQL .= "WHERE id = '$strDataID' ";
        $resDb = $db->execute($strSQL);
        if ($rowDb = $db->fetchrow($resDb)) {
            $bolNewData = false;
            ...
            $arrData['dataBirthday'] = $rowDb['birthday_'];
            ...
            $arrData['dataWeddingDate'] = $rowDb['wedding_date_'];
            ...
            $arrData['dataJoinDate'] = $rowDb['join_date_'];
            $arrData['dataDueDate'] = $rowDb['due_date_'];
            $arrData['dataPermanentDate'] = $rowDb['permanent_date'];
            $arrData['dataResignDate'] = $rowDb['resign_date_'];
    ...
    if ($bolNewData) {
        ...
        $arrData['dataBirthday'] = date("m/d/Y");
        ...
        $arrData['dataJoinDate'] = date("m/d/Y");
        $arrData['dataDueDate'] = "";
...
function saveData($db, &$strDataID, &$strError)
{
    ...
    if ($strDataEmployeeID == "") {
        ...
        return false;
    } else if (!validStandardDate_wal($strDataBirthday) && $strDataBirthday != "") {
        $strError = $error['invalid_date'];
        return false;
    } else if (!validStandardDate_wal($strDataJoinDate) && $strDataJoinDate != "") {
        $strError = $error['invalid_date'];
        return false;
    } else if (!validStandardDate_wal($strDataDueDate) && $strDataDueDate != "") {
        $strError = $error['invalid_date'];
        return false;
    } else if (!validStandardDate($strDataPermanentDate) && $strDataPermanentDate != "") {
        $strError = $error['invalid_date'];
        return false;
    } else if (!validStandardDate_wal($strDataResignDate) && $strDataResignDate != "") {
        $strError = $error['invalid_date'];
        return false;
    } else if (!validStandardDate_wal($strDataWeddingDate) && $strDataWeddingDate != "") {
        $strError = $error['invalid_date'];
        return false;
    ...
    if ($strDataBirthday == "") {
        ...
        $arrDate = explode("/", $strDataBirthday);
        $strDataBirthday = "'" . $arrDate[2] . $arrDate[0] . $arrDate[1] . "'";
    }
    ...
    if ($strDataJoinDate == "") {
        ...
        $arrDate = explode("/", $strDataJoinDate);
        $strDataJoinDate = "'" . $arrDate[2] . $arrDate[0] . $arrDate[1] . "'";
    }
    //$strDataDueDate = ($strDataDueDate == "") ? "NULL" : "'$strDataDueDate'";
    if ($strDataDueDate == "") {
        $strDataDueDate = "NULL";
    } else {
        $arrDate = explode("/", $strDataDueDate);
        $strDataDueDate = "'" . $arrDate[2] . $arrDate[0] . $arrDate[1] . "'";
    }
    ...
    if ($strDataWeddingDate == "") {
        ...
        $arrDate = explode("/", $strDataWeddingDate);
        $strDataWeddingDate = "'" . $arrDate[2] . $arrDate[0] . $arrDate[1] . "'";
    }
    ...
    if ($_SESSION['sessionUserRole'] > ROLE_ADMIN || ($_SESSION['sessionUserRole'] >= ROLE_ADMIN && $bolNew)) {
        if ($bolNew) {
            ...
            $strSQL .= "zakat, gross_up,get_jamsostek,get_bpjs,is_immune_auto_alpha, jamsostek_no, transport, transport_fee, ";
            ...
            $strSQL .= "'$strDataIsZakat', '$strDataIsGrossUp','$strDataIsJamsostek','$strDataIsBPJS','$strDataIsImmuneAutoAlpha','$strDataJamsostekNo', '$strDataTransport', $strDataTransportFee, ";
            ...
            $strSQL .= "zakat = '$strDataIsZakat', gross_up = '$strDataIsGrossUp',get_jamsostek = $strDataIsJamsostek,get_bpjs = $strDataIsBPJS, jamsostek_no = '$strDataJamsostekNo', ";
...
if ($db->connect()) {
    ...
    if ($_SESSION['sessionUserRole'] > ROLE_ADMIN || ($_SESSION['sessionUserRole'] >= ROLE_ADMIN && $bolNew)) {
        ...
        $strInputCity = "<input type=text name=dataZip size=20 maxlength=15 value=\"" . $arrData['dataZip'] . "\" style=\"width:" . (floor(
        ...
        $strInputBirthday = "<input type=text name=dataBirthday id=dataBirthday size=" . ($intDefaultWidth - 5) . " maxlength=10 value=\"" . $arrData['dataBirthday'] . "\"  class=\"form-control datepicker\" data-date-format=\"mm/dd/yyyy\">";
        ...
        $strInputWeddingDate = "<input type=text name=dataWeddingDate id='dataWeddingDate' size=$intDefaultWidth maxlength=10 value=\"" . $arrData['dataWeddingDate'] . "\" style=\"width:$intDefaultWidthPx\" title=\"format:mm/dd/yyyy\" class=\"date-empty form-control datepicker\" data-date-format=\"mm/dd/yyyy\">";
        ...
        $strInputJoinDate = "<input type=text name=dataJoinDate id='dataJoinDate' size=$intDefaultWidth maxlength=10 value=\"" . $arrData['dataJoinDate'] . "\" style=\"width:$intDefaultWidthPx\" class=\"date form-control datepicker\" title=\"format:mm/dd/yyyy\" data-date-format=\"mm/dd/yyyy\">";
        $strInputDueDate = "<input type=text name=dataDueDate id='dataDueDate' size=$intDefaultWidth maxlength=10 value=\"" . $arrData['dataDueDate'] . "\" style=\"width:$intDefaultWidthPx\" class=\"date-empty form-control datepicker\" data-date-format=\"mm/dd/yyyy\">";
        $strInputPermanentDate = "<input type=text name=dataPermanentDate id='dataPermanentDate' size=$intDefaultWidth maxlength=10 value=\"" . $arrData['dataPermanentDate'] . "\" style=\"width:$intDefaultWidthPx\" class=\"date-empty form-control datepicker\" data-date-format=\"mm/dd/yyyy\">";
        $strInputResignDate = "<input type=text name=dataResignDate id='dataResignDate' size=$intDefaultWidth maxlength=10 value=\"" . $arrData['dataResignDate'] . "\" style=\"width:$intDefaultWidthPx\" class=\"date-empty form-control datepicker\" data-date-format=\"mm/dd/yyyy\">";
        ...
        $strInputIsBPJS = ($strInputIsBPJS == 't') ? "Yes" : "No";
