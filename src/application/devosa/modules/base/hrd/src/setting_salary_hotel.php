...
$arrSetting = [
    ...
    //Variable Service Charge Allowance
    "strVarServiceName"         => [
        "code"    => "var_service_name",
        "value"   => "Variable Service Charge",
        "note"    => "Display Name for Variable Service Charge",
        "default" => "Variable Service Charge",
    ],
    "strVarServiceAmount"       => [
        "code"    => "var_service",
        "value"   => "0",
        "note"    => "Amount for Variable Service Charge ",
        "default" => "0",
    ],
    "strVarServiceActive"       => [
        "code"    => "var_service_active",
        "value"   => "t",
        "note"    => "Is Variable Service Charge Active?",
        "default" => "t",
    ],
    "strVarServiceIr"           => [
        "code"    => "var_service_irregular",
        "value"   => "t",
        "note"    => "Is Irregular",
        "default" => "t",
    ],
    "strVarServiceBen"          => [
        "code"    => "var_service_benefit",
        "value"   => "t",
        "note"    => "Is Benefit",
        "default" => "t",
    ],
    "strVarServiceShow"         => [
        "code"    => "var_service_show",
        "value"   => "t",
        "note"    => "Show Variable Service Charge",
        "default" => "t",
    ],
    "strVarServiceProrate"      => [
        "code"    => "var_service_prorate",
        "value"   => "t",
        "note"    => "Prorate Variable Service Charge",
        "default" => "t",
    ],
    "strVarServiceOT"           => [
        "code"    => "var_service_ot",
        "value"   => "t",
        "note"    => "Variable Service Charge include OT",
        "default" => "t",
    ],
    "strVarServiceTax"          => [
        "code"    => "var_service_tax",
        "value"   => "t",
        "note"    => "Variable Service Charge include in tax",
        "default" => "t",
    ],
    "strVarServiceJams"         => [
        "code"    => "var_service_jams",
        "value"   => "t",
        "note"    => "Variable Service Charge include in jamsostek",
        "default" => "t",
    ],
    "strVarServiceDaily"        => [
        "code"    => "var_service_daily",
        "value"   => "t",
        "note"    => "Variable Service Charge include is daily allowance",
        "default" => "f",
    ],
    "strVarServiceHidezero"     => [
        "code"    => "var_service_hidezero",
        "value"   => "t",
        "note"    => "Variable Service Charge  is hidden if the value is zero",
        "default" => "f",
    ],
    //"strTHRMultival" => array("code" => "var_service_multival", "value" => "f", "note" => "Indicator of Out Fix Allow ", "default" => "t",),
    //Leave Allowance
    "strLeaveName"              => [
...
$arrFixAllowance2["VarService"] = ["variable service charge", "data_salary_grade.php"];
$arrFixAllowance2["THR"] = ["thr", ""];
...
function getDataAllowance($db)
{
    ...
    foreach ($arrFixAllowance AS $strKode => $arrTmp) {
        ...
        $strResult .= "  <td><input type=text name=\"str" . $strKode . "Amount\" value=\"" . (float)$arrSetting['str' . $strKode . 'Amount']['value'] . "\" size=20 maxlength=20 class='numeric form-control' class='numeric form-control'></td>\n";
