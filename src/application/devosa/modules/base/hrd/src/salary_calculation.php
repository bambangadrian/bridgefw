...
$strWordsAttendanceDate = getWords("period for overtime");
...
function getDataGrid($db, $strCriteria, $bolLimit = true, $isFullView = false)
{
    ...
    $dataset = $tblSalary->findAll(
        $strCriteria,
        "id, id_company, salary_date, date_from, date_thru, date_from_thr, date_thru_thr, irregular, hide_blank, note, created :: date, approved_time :: date, approved_by,status,as",
        $strOrderBy,
        $strPageLimit,
        $intPageNumber
    );
