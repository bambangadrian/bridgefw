...
$strDetailFooter .= "<td colspan=2><input class='btn btn-sm btn-primary' name='btnDefaultEarly' type='button' id='btnDefaultEarly' value='" . getWords(
        "use default"
    ) . "' onClick='checkDefaultEarly();'></td>";
$strDetailFooter .= "<td colspan=2 nowrap align='left'>&nbsp;</td>";
$strDetailFooter .= "<td colspan=2><input class='btn btn-sm btn-info' name='btnDefaultAfternoon' type='button' id='btnDefaultAfternoon' value='" . getWords(
        "use default"
    ) . "' onClick='checkDefaultAfternoon();'></td>";
...
function getDataBreak($db, $tipe, $strDataID)
{
    ...
    if ($i == 0 && getSetting("ot_auto_break") == 't') {
        ...
        $strResult .= "<tr valign=top id='detailData$tipe" . "_$i'>\n";
        $strResult .= "  <td><input class='form-control' type=text name=dataBreak$tipe" . "_$i size=12 maxlength=10 value=$strStartBreak></td>\n";
        ...
        $strResult .= "  <td><input class='form-control' type=text name=dataBreakFinish$tipe" . "_$i size=12 maxlength=10 value=$strDefaultBreak></td>\n";
    ...
    while ($i <= $intMaxDetail) {
        ...
        $strResult .= "  <td><input class='form-control' type=text name=dataBreak$tipe" . "_$i size=12 maxlength=10 value=$strDefaultBreak $strDis></td>\n";
        $strResult .= "  <td><input class='form-control' type=text name=dataDuration$tipe" . "_$i size=12 maxlength=10 value=0 $strDis></td>\n";
        //$strResult .= "  <td>&nbsp;</td>\n";
        $strResult .= "  <td><input class='form-control' type=text name=dataBreakFinish$tipe" . "_$i size=12 maxlength=10 value=$strDefaultBreak $strDis></td>\n";
...
if ($db->connect()) {
    ...
    $strInputEarly1 = "<input class='form-control' type=text name=\"dataStartEarly\" size=5 maxlength=5 value=\"" . $arrData['dataStartEarly'] . "\"  onChange=\"setDefault('Early');\">";
    $strInputEarly2 = "<input class='form-control' type=text name=\"dataFinishEarly\" size=5 maxlength=5 value=\"" . $arrData['dataFinishEarly'] . "\"  onChange=\"setDefault('Early');\">";
    $strInputEarly3 = "<div class='checkbox no-margin no-padding'><label><input class='checkbox-inline' type=\"checkbox\" name=\"chkEarly\" onChange=\"setEarly()\" $strChecked></label></div>";
    ...
    $strInputAfternoon1 = "<input class='form-control' type=text name=dataStart size=5 maxlength=5 value=" . $arrData['dataStart'] . "  onChange=\"setDefault(''); \" >";
    $strInputAfternoon2 = "<input class='form-control' type=text name=dataFinish size=5 maxlength=5 value=" . $arrData['dataFinish'] . "  onChange=\"setDefault('');\" >";
    ...
    $strInputEntryDate = "<input class='form-control datepicker' type=text name=dataEntryDate id=dataEntryDate size=12 maxlength=10   value=\"" . $arrData['dataEntryDate'] . "\" readonly data-date-format='yyyy-mm-dd'>";
    $strInputDate = "<input class='form-control datepicker' type=text name=dataDate id=dataDate size=12 maxlength=10 value='" . $arrData['dataDate'] . "' data-date-format='yyyy-mm-dd'>";
