...
function getDataGrid($db, $strCriteria, $bolLimit = true, $isFullView = false, $isExport = false)
{
    ...
    */
    ...
    if (!$bolIrregular) {
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("att. allowance"),
                "alw_tunjangan_kehadiran",
                ["width" => 90],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("attendance deduction"),
                "ded_attendance_deduction",
                ["width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
...
if ($db->connect()) {
    ...
    $strCalculationMenu = "<b><a href='salary_calculation.php'>" . getWords(
