...
doInclude('libraries/classes/hrd/hrd_medical_additional_quota.php');
...
$strPageDesc = getWords("medical additional quota management");
$pageHeader = pageHeader($pageIcon, $strPageTitle, $strPageDesc);
$pageSubMenu = medicalTypeSubmenu($strWordsExtendedQuota);
