...
if ($db->connect()) {
    ...
    $strInputDateFrom = "<input class='form-control datepicker' data-date-format='mm/dd/yyyy' type=text name=dataDateFrom id=dataDateFrom size=15 maxlength=10 value=" . ($strDateFrom = getInitialValue(
            "DateFrom",
            date("m/d/Y")
        )) . ">";
    $strInputDateThru = "<input class='form-control datepicker' data-date-format='mm/dd/yyyy' type=text name=dataDateThru id=dataDateThru size=15 maxlength=10 value=" . ($strDateThru = getInitialValue(
            "DateThru",
            date("m/d/Y")
        )) . ">";
    ...
    if ($strDateFrom == $strDateThru) {
        $strInfo .= "<br>" . strtoupper(pgDateFormat($strDateFrom, "M/d/Y"));
    } else {
        $strInfo .= "<br>" . strtoupper(pgDateFormat($strDateFrom, "M/d/Y"));
        $strInfo .= " >> " . strtoupper(pgDateFormat($strDateThru, "M/d/Y"));
    }
