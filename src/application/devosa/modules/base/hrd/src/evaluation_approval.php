...
function getData($db)
{
    ...
    if ($db->connect()) {
        ...
        $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluator id"), "evaluator_id", "", ['nowrap' => '']));
        $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluator name"), "evaluator_name", "", ['nowrap' => '']));
        ...
        $myDataGrid->addColumn(new DataGrid_Column(getWords("division"), "division_name", "", ['nowrap' => '']));
        $myDataGrid->addColumn(new DataGrid_Column(getWords("department"), "department_name", "", ['nowrap' => '']));
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("evaluation date"), "evaluation_date", "", ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("period from"), "evaluation_period_from", "", ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("period thru"), "evaluation_period_thru", "", ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("expected total score"),
                "expected_total",
                "",
                ['align' => 'right', 'nowrap' => ''],
                false,
        ...
        generateRoleButtons(
            ($dataPrivilege['edit'] == 't'),
            ($dataPrivilege['delete'] == 't'),
            ($dataPrivilege['check'] == 't'),
            ($dataPrivilege['approve'] == 't'),
            true,
            true,
            $myDataGrid
        );
