...
doInclude('libraries/classes/hrd/hrd_facility.php');
...
$myDataGrid->addColumn(new DataGrid_Column(getWords("name"), "name", ['width' => '150'], ['nowrap' => '']));
...
function saveData()
{
    ...
    if ($isNew) {
        ...
        $bolSuccess = $dataHrdFacility->update(/*pk*/
