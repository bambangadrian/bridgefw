...
//doInclude('plugins/tbs_plugin_opentbs_1.9.4/demo/tbs_class.php'); // Load the TinyButStrong template engine
//doInclude('plugins/tbs_plugin_opentbs_1.9.4/tbs_plugin_opentbs.php'); // Load the OpenTBS plugin
