...
if ($db->connect()) {
    ...
    $strInputDateFrom = "<input type=text name=dataDateFrom id=dataDateFrom size=15 maxlength=10 value=\"$strDataDateFrom\" class=\"form-control datepicker\" data-date-format=\"yyyy-mm-dd\">";
    $strInputDateThru = "<input type=text name=dataDateThru id=dataDateThru size=15 maxlength=10 value=\"$strDataDateThru\" class=\"form-control datepicker\" data-date-format=\"yyyy-mm-dd\">";
