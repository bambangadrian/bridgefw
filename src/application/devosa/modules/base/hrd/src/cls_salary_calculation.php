    ...
    */
    function initEmployee($strKriteria = "")
    {
        ...
        SELECT te.id, te.employee_id, te.employee_name, te.id_company,  te.management_code, te.division_code, te.zakat, te.get_jamsostek, te.get_bpjs,
          ...
          OR (join_date <= DATE '" . $this->arrData['salary_finish_date'] . "' AND (resign_date is null OR resign_date > '" . $this->arrData['salary_finish_date'] . "'))
          $strKriteria)
        ) AS te
    ...
    */
    function calculateOvertime()
    {
        ...
        foreach ($this->arrDetail AS $strID => $arrInfo) {
            ...
            $intOTMealCounter = $objOT->getData($strID, "ot_meal_counter");
            ...
            // if ($strID == 2267) {
            //   echo $intOTMealCounter;
            //   echo "kecebong";
            //   echo $this->arrEmployee[$strID]['ot_meal_fee'];
            //   die();
            // }
    ...
    */
    function calculateJamsostek()
    {
        ...
        foreach ($this->arrDetail AS $strID => $arrInfo) {
            ...
            $baseBPJS = $this->arrConf['bpjs_max'];
