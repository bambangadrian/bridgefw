...
doInclude('libraries/classes/hrd/hrd_training_type.php');
doInclude('libraries/classes/hrd/hrd_training_request.php');
doInclude('libraries/classes/hrd/hrd_training_request_participant.php');
