...
doInclude('plugins/tbsclassplugins/tbs_plugin_opentbs.php');
...
if ($showReport) {
    ...
    $dataMasterSalary = getMasterSalarybyYear($intYear);
...
$strPageDesc = getWords('tax report page');
...
function getAnnualTax($db, $intYear, $strKriteria = "")
{
    ...
    //    echo $intPage;
    $strSQL = "SELECT id, EXTRACT(MONTH FROM \"salary_date\") as mon FROM \"hrd_salary_master\" WHERE EXTRACT(YEAR FROM \"salary_date\") = '$intYear' AND status=2";
