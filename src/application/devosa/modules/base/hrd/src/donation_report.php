...
if ($db->connect()) {
    ...
    $fFilter->addSelect(
        ...
        "dataDonationType",
        getDataListDonationType(
            getInitialValue("DonationType"),
            true,
    ...
    $fFilter->addInputAutoComplete(
        ...
        "dataEmployeeID",
        getDataEmployee(getInitialValue("Employee", "", $strDataEmployee)),
    ...
    $fFilter->addInput(
        getWords("minimum amount"),
        "dataAmountFrom",
        getInitialValue("AmountFrom"),
        "",
        "numeric",
        false,
        true,
    ...
    $fFilter->addInput(
        getWords("maximum amount"),
        "dataAmountThru",
        getInitialValue("AmountThru"),
        "",
        "numeric",
        false,
        true,
    ...
    $fFilter->addSelect(
        getWords("bank"),
        "dataBank",
        getDataListBank(getInitialValue("Bank"), true),
        ["style" => "width:$strDefaultWidthPx"],
        "",
        false
    );
