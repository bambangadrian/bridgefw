...
class clsAttendanceInfo
{
        ...
        if (count($arrTmp) > 0) {
            ...
            if (isset($objAttendanceClass->arrShift[$strTmpAttendanceDate][$strTmpIDEmployee])) {
                ...
                if ($arrTemp['shift_off'] == "t" || isHoliday(
                        ...
                        false /*if false means only checks public holiday*/
                    )
                ) {
                    $this->strNormalStart = "";
                    $this->strNormalFinish = "";
    ...
    function createCurrentAttendance(&$objAttendanceClass, $strDataSource = "")
    {
        ...
        if (!isset($objAttendanceClass->arrAttendanceChanges[$this->strAttendanceDate][$this->strIDEmployee])) {
            $objAttendanceClass->arrAttendanceChanges[$this->strAttendanceDate][$this->strIDEmployee] = (isset($objAttendanceClass->arrAttendance[$this->strAttendanceDate][$this->strIDEmployee])) ? $objAttendanceClass->arrAttendance[$this->strAttendanceDate][$this->strIDEmployee] : [];
