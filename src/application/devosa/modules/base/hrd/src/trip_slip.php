...
function getData($db)
{
    ...
    if ($db->connect() && $strDataTripTypeID != "") {
        ...
        $myDataGrid->addColumnCheckbox(
            new DataGrid_Column(
                "chkID", "id", ["rowspan" => 2, 'width' => '30'], ['align' => 'center', 'nowrap' => '']
            ),
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("form code"), "form_code", ["rowspan" => 2], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(new DataGrid_Column(getWords("created"), "created", ["rowspan" => 2], ['nowrap' => '']));
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("date from"), "date_from", ["rowspan" => 2], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("date thru"), "date_thru", ["rowspan" => 2], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
