...
doInclude('plugins/treeview/treeview.php');
...
function getDataTree($db)
{
    ...
    $arrMan = $tblMan->findAll(
        "management_code LIKE '" . printCompanyCode($_SESSION['sessionCAR']) . "%'",
        null,
        "management_code"
    );
    //add 28-11-2012 by adnan
...
if ($bolPrint) {
    ...
    $myTreeview = new clsTreeView("treeView1", "plugins/treeview/", true);
