...
function showRows($strNo, $rowData, $strClass = "")
{
    ...
    $strResult .= "  <td nowrap class=\"center\">&nbsp;" . minuteToTime($rowData['totalLate']) . "</td>\n";
    $strResult .= "  <td nowrap class=\"center\">&nbsp;" . $rowData['early'] . "</td>\n";
    $strResult .= "  <td nowrap class=\"center\">&nbsp;" . minuteToTime($rowData['totalEarly']) . "</td>\n";
...
if ($db->connect()) {
    ...
    //$strDataDateFrom    = (isset($_SESSION['sessionFilterDateFrom']))   ? $_SESSION['sessionFilterDateFrom']    : date("m/d/Y");
    //$strDataDateThru    = (isset($_SESSION['sessionFilterDateThru']))   ? $_SESSION['sessionFilterDateThru']    : date("m/d/Y");
    $strDataDateFrom = (isset($_SESSION['sessionFilterDateFrom'])) ? $_SESSION['sessionFilterDateFrom'] : date("m/d/Y");
    $strDataDateThru = (isset($_SESSION['sessionFilterDateThru'])) ? $_SESSION['sessionFilterDateThru'] : date("m/d/Y");
    ...
    if ($bolCanView) {
        ...
        if (validStandardDate_wal($strDataDateFrom) && validStandardDate_wal($strDataDateThru) && $bolShow) {
    ...
    $strInputDateFrom = "<input class=\"form-control datepicker\" type=text name=dataDateFrom id=dataDateFrom maxlength=10 value=\"$strDataDateFrom\" onChange=\"document.getElementById('dataDateThru').value=this.value\" data-date-format=\"mm/dd/yyyy\">";
    $strInputDateThru = "<input class=\"form-control datepicker\" type=text name=dataDateThru id=dataDateThru maxlength=10 value=\"$strDataDateThru\" data-date-format=\"mm/dd/yyyy\">";
