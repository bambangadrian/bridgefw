...
//  $f->addInputAutoComplete(getWords("employee id"), "employeeName", getDataEmployee(getInitialValue("Employee", null, $strDataEmployee)), "style=width:$strDefaultWidthPx ".$strEmpReadonly, "string", true, true, true, "", "", true, null, "hrd_ajax_source.php?action=getemployee");
