...
doInclude('libraries/classes/hrd/hrd_training_category.php');
doInclude('libraries/classes/hrd/hrd_training_need_analysis_master.php');
doInclude('libraries/classes/hrd/hrd_training_need_analysis_detail_by_type.php');
...
if ($bolCanView) {
    ...
    $f->addSelect(
        getWords("grade"),
        "dataGrade",
        getDataListSalaryGrade($strDataGrade, true),
        ["style" => "width:270"]
    );
