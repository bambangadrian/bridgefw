...
if ($strDataEmployee != "") {
    ...
    $arrTemp = $dataHrdEvaluationCriteriaEmployee->find(
        "active = 't' AND is_last_updated = 't' AND id_employee = '" . $arrEmployee['id'] . "' AND date_from = '$strDataDateFrom' AND date_thru = '$strDataDateThru'",
...
if ($bolCanEdit) {
    ...
    $f->addSelect(
        ...
        "dataIDCategory",
        getDataListEvaluationCategory($strDataIDCategory, false, null, "individual_evaluation = 't'"),
        ["style" => "width:270"]
    );
    $f->addInput(
        getWords("employee"),
