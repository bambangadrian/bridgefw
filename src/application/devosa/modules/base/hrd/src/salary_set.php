...
doInclude('libraries/classes/hrd/hrd_employee_basic_salary.php');
doInclude('libraries/classes/hrd/hrd_employee_allowance.php');
doInclude('libraries/classes/hrd/hrd_employee_deduction.php');
doInclude('libraries/classes/hrd/hrd_basic_salary_set.php');
...
function saveData()
{
    ...
    $data = [
        "start_date"           => $f->getValue('dataStartDate'),
