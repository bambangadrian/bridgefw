...
if ($db->connect()) {
    ...
    $arrData['dataDateFrom'] = (getPostValue('dataDateFrom') != "" && validStandardDate(
            getPostValue('dataDateFrom')
        )) ? getPostValue('dataDateFrom') : date("Y-m") . "-01";
    $arrData['dataDateThru'] = (getPostValue('dataDateThru') != "" && validStandardDate(
            getPostValue('dataDateThru')
        )) ? getPostValue('dataDateThru') : date("Y-m-d");
...
$strPageDesc = getWords("medical report page");
$pageHeader = pageHeader($pageIcon, $strPageTitle, $strPageDesc);
$pageSubMenu = medicalQuotaSubmenu($strWordsMedicalClaimList);
if ($bolPrint) {
