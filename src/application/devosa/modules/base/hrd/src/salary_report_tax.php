...
function getAnnualTax($db, $intYear, $strKriteria = "")
{
    ...
    while ($row = $db->fetchrow($res)) {
        ...
        $strSQL2 = "SELECT t0.\"id_employee\", t0.\"employee_id\", \"base_tax\", \"base_irregular_tax\", tax, \"irregular_tax\" , jkk_allowance, \"basic_salary\", t0.npwp,
                        t1.\"family_status_code\", \"join_date\", \"resign_date\", t1.\"employee_name\", \"primary_address\",t1.\"primary_city\",t1.\"primary_zip\", t1.gender, t2.\"tax_reduction\", t3.\"position_name\", t2.children, t2.\"marital_status\", t0.jamsostek_deduction, t0.pension_deduction
