...
function getData($db, &$arrData, $strDataID = "")
{
    ...
    if ($bolNewData) {
        $arrData['dataEntryDate'] = date("m/d/Y");
        $arrData['dataDate'] = date("m/d/Y");
        $arrData['dataSection'] = "";
...
if ($db->connect()) {
    ...
    $strInputEarly1 = "<input class='form-control' type=text name=\"dataStartEarly\" size=5 maxlength=5 value=\"" . $arrData['dataStartEarly'] . "\"  onChange=\"setDefault('Early');\" readonly>";
    $strInputEarly2 = "<input class='form-control' type=text name=\"dataFinishEarly\" size=5 maxlength=5 value=\"" . $arrData['dataFinishEarly'] . "\"  onChange=\"setDefault('Early');\" readonly>";
