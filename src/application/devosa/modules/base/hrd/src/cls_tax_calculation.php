...
doInclude('cls_pph21_calculation.php');
 ...
 */
    ...
    // uddin 20151208
    //function calculatePph21GrossUpAnnualizedNet($fltNetIncome, $bolNPWP, $fltPTKP, $fltJamsostekDeduction , $taxableDayUpToEndOfYear, $taxableDayUpToCurrent, $taxableMonth, $currentTaxableMonth)
