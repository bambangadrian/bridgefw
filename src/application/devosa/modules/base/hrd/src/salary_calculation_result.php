...
doInclude('cls_salary_calculation.php');
doInclude('cls_employee.php');
...
function getSlip()
{
    ...
    doInclude('cls_annual_leave.php');
...
function getDataGrid($db, $strCriteria, $bolLimit = true, $isFullView = false, $isExport = false)
{
    ...
    $myDataGrid->pageSortBy = "\"grouper\",join_date";
    ...
    */
    ...
    if (!$bolIrregular) {
        $myDataGrid->addSpannedColumn(getWords("other tax allowance"), 6);
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tunjangan jabatan"),
                "alw_jabatan_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tunjangan transport"),
                "alw_transport_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tunjangan jamsostek"),
                "alw_jamsostek_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("tax allowance irregular"), "irregular_tax_allowance", array("rowspan" => 1, "width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "irregular_tax_allowance"));
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("overtime allowance"),
                "overtime_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
        ...
        $myDataGrid->addSpannedColumn(getWords("other non tax allowance"), 3);
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tunjangan kendaraan"),
                "alw_vehicle_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tunjangan suka duka"),
                "alw_suka_duka_allowance",
                ["rowspan" => 1, "width" => 70],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
                true,
        ...
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("other tax allowance"), "alw_other_tax_allowance", array("rowspan" => 2, "width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "alw_other_tax_allowance"));
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("other non tax allowance tunjangan"), "alw_other_non_tax_allowance", array("rowspan" => 2, "width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "alw_other_non_tax_allowance"));
        $myDataGrid->addSpannedColumn(getWords("b p j s by perusahaan"), 5);
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("JHT 3.7% by company"),
                "jamsostek_allowance",
                ["width" => 50],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("BPJS Kesehatan 4% by company"),
                "bpjs_allowance",
                ["rowspan" => 1, "width" => 50],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
        ...
        $myDataGrid->addSpannedColumn(getWords("deduction"), 6);
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("JHT 2% by employee"),
                "jamsostek_deduction",
                ["width" => 50],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("BPJS Kesehatan 1% by employee"),
                "bpjs_deduction",
                ["width" => 50],
                ["nowrap" => "nowrap", "align" => "right"],
                false,
        ...
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("excess medical"), "ded_medical_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_medical_deduction"));
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("absen"),
                "absence_deduction",
        ...
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("griya makmur"), "ded_griya_makmur", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_griya_makmur"));
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("pulsa c u g"), "ded_pulsa_cug", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_pulsa_cug"));
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("perjalanan dinas"), "ded_perjalanan_dinas", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_perjalanan_dinas"));
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("loan"), "ded_loan_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_loan_deduction"));
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("lain lain"), "ded_other_deduction", array("width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric()", "numeric", true, 15, true, "ded_other_deduction"));
        $myDataGrid->addColumn(
            new DataGrid_Column(
                getWords("tax"),
                "deduction_tax",
        ...
        // $myDataGrid->addColumn(new DataGrid_Column(getWords("irregular tax"), "irregular_tax", array("rowspan" => 1,"width" => 70),  array("nowrap" => "nowrap", "align" => "right"), false, true, "", "formatNumeric(ignoreZero=true,decimal=2)", "numeric", true, 15, true, "irregular_tax"));
    }
