...
doInclude('libraries/classes/datagrid_modified.php');
doInclude('plugins/form2/form2.php');
doInclude('libraries/classes/hrd/hrd_employee_mutation.php');
doInclude('libraries/classes/hrd/hrd_employee_mutation_resign.php');
