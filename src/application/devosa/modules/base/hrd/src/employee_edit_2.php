...
if ($db->connect()) {
    ...
    if ($_SESSION['sessionUserRole'] > ROLE_ADMIN || ($_SESSION['sessionUserRole'] >= ROLE_ADMIN && $bolNew)) {
        ...
        $strInputCity = "<input type=text name=dataCity size=20 maxlength=31 value=\"" . $arrData['dataCity'] . "\" style=\"width:" . (floor(
                    ($intDefaultWidthPx / 3) * 2
                ) - 13) . "\">";
        ...
        $strInputLivingCost = getLivingCostList(
            $db,
            "dataLivingCost",
            $arrData['dataLivingCost'],
            $strEmptyOption,
