...
$arrSetting = [
    ...
    //pension Allowance
    "strPensionAllowName"         => [
        "code"    => "pension_allowance_name",
        "value"   => "pension Allowance",
        "note"    => "Display Name for pension Allow",
        "default" => "Pension Allowance",
    ],
    "strPensionAllowAmount"       => [
        "code"    => "pension_allowance",
        "value"   => "0",
        "note"    => "Amount for pension Allow %",
        "default" => "0",
    ],
    "strPensionAllowActive"       => [
        "code"    => "pension_allowance_active",
        "value"   => "t",
        "note"    => "Is pension Allow Active?",
        "default" => "t",
    ],
    "strPensionAllowIr"           => [
        "code"    => "pension_allowance_irregular",
        "value"   => "t",
        "note"    => "Is Irregular",
        "default" => "t",
    ],
    "strPensionAllowBen"          => [
        "code"    => "pension_allowance_benefit",
        "value"   => "t",
        "note"    => "Is Benefit",
        "default" => "t",
    ],
    "strPensionAllowShow"         => [
        "code"    => "pension_allowance_show",
        "value"   => "t",
        "note"    => "Show pension Allow",
        "default" => "t",
    ],
    "strPensionAllowProrate"      => [
        "code"    => "pension_allowance_prorate",
        "value"   => "t",
        "note"    => "Prorate pension Allow",
        "default" => "t",
    ],
    "strPensionAllowOT"           => [
        "code"    => "pension_allowance_ot",
        "value"   => "t",
        "note"    => "pension Allow include OT",
        "default" => "t",
    ],
    "strPensionAllowTax"          => [
        "code"    => "pension_allowance_tax",
        "value"   => "t",
        "note"    => "pension Allow include in tax",
        "default" => "t",
    ],
    "strPensionAllowJams"         => [
        "code"    => "pension_allowance_jams",
        "value"   => "f",
        "note"    => "pension Allow include in jamsostek",
        "default" => "f",
    ],
    "strPensionAllowDaily"        => [
        "code"    => "pension_allowance_daily",
        "value"   => "t",
        "note"    => "pension Allow include is daily allowance",
        "default" => "f",
    ],
    "strPensionAllowHidezero"     => [
        "code"    => "pension_allowance_hidezero",
        "value"   => "t",
        "note"    => "pension Allow  is hidden if the value is zero",
        "default" => "f",
    ],
    "strBPJSAllowanceName"        => [
        "code"    => "bpjs_allowance_name",
        "value"   => "BPJS allowance",
        "note"    => "Display Name for BPJS",
        "default" => "BPJS allowance",
    ],
    "strBPJSAllowanceAmount"      => [
        "code"    => "bpjs_allowance",
        "value"   => "0",
        "note"    => "Amount for BPJS allowance %",
        "default" => "0",
    ],
    "strBPJSAllowanceActive"      => [
        "code"    => "bpjs_allowance_active",
        "value"   => "t",
        "note"    => "Is BPJS allowance Active?",
        "default" => "t",
    ],
    "strBPJSAllowanceIr"          => [
        "code"    => "bpjs_allowance_irregular",
        "value"   => "t",
        "note"    => "Is Irregular",
        "default" => "t",
    ],
    "strBPJSAllowanceBen"         => [
        "code"    => "bpjs_allowance_benefit",
        "value"   => "t",
        "note"    => "Is Benefit",
        "default" => "t",
    ],
    "strBPJSAllowanceShow"        => [
        "code"    => "bpjs_allowance_show",
        "value"   => "t",
        "note"    => "Show BPJS allowance ",
        "default" => "t",
    ],
    "strBPJSAllowanceProrate"     => [
        "code"    => "bpjs_allowance_prorate",
        "value"   => "t",
        "note"    => "Prorate BPJS allowance ",
        "default" => "t",
    ],
    "strBPJSAllowanceOT"          => [
        "code"    => "bpjs_allowance_ot",
        "value"   => "t",
        "note"    => "BPJS allowance include OT",
        "default" => "t",
    ],
    "strBPJSAllowanceTax"         => [
        "code"    => "bpjs_allowance_tax",
        "value"   => "t",
        "note"    => "BPJS allowance include in tax",
        "default" => "t",
    ],
    "strBPJSAllowanceJams"        => [
        "code"    => "bpjs_allowance_jams",
        "value"   => "f",
        "note"    => "BPJS allowance include in jamsostek",
        "default" => "f",
    ],
    "strBPJSAllowanceDaily"       => [
        "code"    => "bpjs_allowance_daily",
        "value"   => "t",
        "note"    => "BPJS allowance include is daily allowance",
        "default" => "f",
    ],
    "strBPJSAllowanceHidezero"    => [
        "code"    => "bpjs_allowance_hidezero",
        "value"   => "t",
    ...
    "strAbsenceDeductionName"     => [
        "code"    => "absence_deduction_name",
        "value"   => "Absence Deduction",
        "note"    => "Display Name for absence",
        "default" => "absence Deduction",
    ],
    "strAbsenceDeductionAmount"   => [
        "code"    => "absence_deduction",
        "value"   => "0",
        "note"    => "Amount for absence",
        "default" => "0",
    ],
    "strAbsenceDeductionActive"   => [
        "code"    => "absence_deduction_active",
        "value"   => "t",
        "note"    => "Is absence Active?",
        "default" => "t",
    ],
    "strAbsenceDeductionShow"     => [
        "code"    => "absence_deduction_show",
        "value"   => "t",
        "note"    => "Show absence ",
        "default" => "t",
    ],
    "strAbsenceDeductionProrate"  => [
        "code"    => "absence_deduction_prorate",
        "value"   => "t",
        "note"    => "Prorate absence ",
        "default" => "t",
    ],
    "strAbsenceDeductionOT"       => [
        "code"    => "absence_deduction_ot",
        "value"   => "t",
        "note"    => "absence include OT",
        "default" => "t",
    ],
    "strAbsenceDeductionTax"      => [
        "code"    => "absence_deduction_tax",
        "value"   => "t",
        "note"    => "absence include in tax",
        "default" => "t",
    ],
    "strAbsenceDeductionJams"     => [
        "code"    => "absence_deduction_jams",
        "value"   => "f",
        "note"    => "absence include in jamsostek",
        "default" => "f",
    ],
    "strAbsenceDeductionDaily"    => [
        "code"    => "absence_deduction_daily",
        "value"   => "t",
        "note"    => "absence Deduc include is daily deduction",
        "default" => "f",
    ],
    "strAbsenceDeductionHidezero" => [
        "code"    => "absence_deduction_hidezero",
        "value"   => "t",
        "note"    => "absence Deduc is hidden if the value is zero",
        "default" => "f",
    ],
    "strLateDeductionName"        => [
        "code"    => "late_deduction_name",
        "value"   => "Late Deduction",
        "note"    => "Display Name for late",
        "default" => "Late Deduction",
    ],
    "strLateDeductionAmount"      => [
        "code"    => "late_deduction",
        "value"   => "0",
        "note"    => "Amount for late",
        "default" => "0",
    ],
    "strLateDeductionActive"      => [
        "code"    => "late_deduction_active",
        "value"   => "t",
        "note"    => "Is late Active?",
        "default" => "t",
    ],
    "strLateDeductionShow"        => [
        "code"    => "late_deduction_show",
        "value"   => "t",
        "note"    => "Show late ",
        "default" => "t",
    ],
    "strLateDeductionProrate"     => [
        "code"    => "late_deduction_prorate",
        "value"   => "t",
        "note"    => "Prorate late ",
        "default" => "t",
    ],
    "strLateDeductionOT"          => [
        "code"    => "late_deduction_ot",
        "value"   => "t",
        "note"    => "late include OT",
        "default" => "t",
    ],
    "strLateDeductionTax"         => [
        "code"    => "late_deduction_tax",
        "value"   => "t",
        "note"    => "late include in tax",
        "default" => "t",
    ],
    "strLateDeductionJams"        => [
        "code"    => "late_deduction_jams",
        "value"   => "f",
        "note"    => "late include in jamsostek",
        "default" => "f",
    ],
    "strLateDeductionDaily"       => [
        "code"    => "late_deduction_daily",
        "value"   => "t",
        "note"    => "late Deduc include is daily deduction",
        "default" => "f",
    ],
    "strLateDeductionHidezero"    => [
        "code"    => "late_deduction_hidezero",
        "value"   => "t",
    ...
    "strBPJSDeducName"            => [
        ...
        "value"   => "BPJS Deduction",
        "note"    => "Display Name for BPJS Deduc",
        "default" => "Jamsostec Deduction",
    ],
    "strBPJSDeducAmount"          => [
        "code"    => "bpjs_deduction",
        "value"   => "0",
        "note"    => "Amount for BPJS Deduc %",
        "default" => "0",
    ],
    "strBPJSDeducActive"          => [
        "code"    => "bpjs_deduction_active",
        "value"   => "t",
        "note"    => "Is BPJS Deduc Active?",
        "default" => "t",
    ],
    "strBPJSDeducShow"            => [
        "code"    => "bpjs_deduction_show",
        "value"   => "t",
        "note"    => "Show BPJS Deduc ",
        "default" => "t",
    ],
    "strBPJSDeducProrate"         => [
        "code"    => "bpjs_deduction_prorate",
        "value"   => "t",
        "note"    => "Prorate BPJS Deduc ",
        "default" => "t",
    ],
    "strBPJSDeducOT"              => [
        "code"    => "bpjs_deduction_ot",
        "value"   => "t",
        "note"    => "BPJS Deduc include OT",
        "default" => "t",
    ],
    "strBPJSDeducTax"             => [
        "code"    => "bpjs_deduction_tax",
        "value"   => "t",
        "note"    => "BPJS Deduc include in tax",
        "default" => "t",
    ],
    "strBPJSDeducJams"            => [
        "code"    => "bpjs_deduction_jams",
        "value"   => "f",
        "note"    => "BPJS Deduc include in jamsostek",
        "default" => "f",
    ],
    "strBPJSDeducDaily"           => [
        "code"    => "bpjs_deduction_daily",
        "value"   => "t",
        "note"    => "BPJS Deduc include is daily deduction",
        "default" => "f",
    ],
    "strBPJSDeducHidezero"        => [
        "code"    => "bpjs_deduction_hidezero",
        "value"   => "t",
        "note"    => "BPJS Deduc  is hidden if the value is zero",
        "default" => "f",
    ],
    //Pension Deduction
    "strPensionDeducName"         => [
        "code"    => "pension_deduction_name",
        "value"   => "pension Deduction",
        "note"    => "Display Name for pension Deduc",
        "default" => "pension Deduction",
    ],
    "strPensionDeducAmount"       => [
        "code"    => "pension_deduction",
        "value"   => "0",
        "note"    => "Amount for pension Deduc %",
        "default" => "0",
    ],
    "strPensionDeducActive"       => [
        "code"    => "pension_deduction_active",
        "value"   => "t",
        "note"    => "Is pension Deduc Active?",
        "default" => "t",
    ],
    "strPensionDeducShow"         => [
        "code"    => "pension_deduction_show",
        "value"   => "t",
        "note"    => "Show pension Deduc ",
        "default" => "t",
    ],
    "strPensionDeducProrate"      => [
        "code"    => "pension_deduction_prorate",
        "value"   => "t",
        "note"    => "Prorate pension Deduc ",
        "default" => "t",
    ],
    "strPensionDeducOT"           => [
        "code"    => "pension_deduction_ot",
        "value"   => "t",
        "note"    => "pension Deduc include OT",
        "default" => "t",
    ],
    "strPensionDeducTax"          => [
        "code"    => "pension_deduction_tax",
        "value"   => "t",
        "note"    => "pension Deduc include in tax",
        "default" => "t",
    ],
    "strPensionDeducJams"         => [
        "code"    => "pension_deduction_jams",
        "value"   => "f",
        "note"    => "pension Deduc include in jamsostek",
        "default" => "f",
    ],
    "strPensionDeducDaily"        => [
        "code"    => "pension_deduction_daily",
        "value"   => "t",
        "note"    => "pension Deduc include is daily deduction",
        "default" => "f",
    ],
    "strPensionDeducHidezero"     => [
        "code"    => "pension_deduction_hidezero",
        "value"   => "t",
...
function getDataAllowance($db)
{
    ...
    /*
      ...
      $strResult .= "  <td class=center><input type=text name=\"strBasicName\" size=30 maxlength=40 value=\"" .$arrSetting['strBasicName']['value']."\"></td>\n";
      $strResult .= "  <td class=center>&nbsp;</td>\n";
      $strResult .= "  <td class=center>&nbsp;</td>\n";
      $strResult .= "  <td class=center>&radic;</td>\n";
      $strResult .= "  <td class=center>&radic;</td>\n";
      $strResult .= "  <td class=center>&radic;</td>\n";
      $strResult .= "  <td class=center>&radic;</td>\n";
      $strResult .= "  <td class=center>&radic;</td>\n";
    ...
    foreach ($arrFixAllowance AS $strKode => $arrTmp) {
        ...
        foreach ($arrAllowanceAttributes AS $arrAttribute) {
            ...
            $strAttribute .= " <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"str" . $strKode . $arrAttribute['name'] . "\" value='t' $strChecked></label></div></td>\n";
        }
        $strResult .= "<tr valign=top>\n";
        $strResult .= "  <td>&nbsp;</td>\n<td>&nbsp;</td>\n";
        $strResult .= "  <td nowrap>&nbsp;" . $arrTmp[0] . " (" . $arrTmp[1] . ")</td>\n";
        $strResult .= "  <td class=center><input type=text name=\"str" . $strKode . "Name\" size=30 maxlength=40 value=\"" . $arrSetting['str' . $strKode . 'Name']['value'] . "\" class='string form-control'></td>\n";
        $strResult .= "  <td><input type=text name=\"str" . $strKode . "Amount\" value=\"" . (float)$arrSetting['str' . $strKode . 'Amount']['value'] . "\" size=20 maxlength=20 class='numeric form-control'></td>\n";
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
        ...
        foreach ($arrAllowanceAttributes AS $arrAttribute) {
            ...
            $strAttribute .= " <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"data" . $arrAttribute['name'] . "Allowance_$intRows\" value='t' $strChecked></label></div></td>\n";
        }
        $strResult .= "<tr valign=top id='detailDataAllowance" . "_$intRows'>\n";
        $strResult .= "  <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"cbxAllow" . "_$intRows\" value='" . $rowDb['id'] . "' ></label></div></td>\n";
        $strResult .= "  <td><input class=form-control type=text name=dataSeqAllowance" . "_$intRows size=5 value=\"" . $rowDb['seq'] . "\">";
        $strResult .= "  <td><input type=hidden name=dataIDAllowance" . "_$intRows value=\"" . $rowDb['id'] . "\">";
        $strResult .= "<input type=text name=dataCodeAllowance" . "_$intRows value=\"" . $rowDb['code'] . "\" size=20 maxlength=40 onChange=\"changeCode('Allowance',$intRows)\" class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataNameAllowance" . "_$intRows value=\"" . $rowDb['name'] . "\" size=30 maxlength=40 class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input class=form-control type=text name=dataAmountAllowance" . "_$intRows value=\"" . $rowDb['amount'] . "\" size=20 ></td>\n";
        $strResult .= $strAttribute;
        $strResult .= "</tr>\n";
    }
    $intNumShow = $intRows;
    ...
    while ($intRows <= $intMaxDetail) {
        ...
        $strAttribute = "";
        foreach ($arrAllowanceAttributes AS $arrAttribute) {
            $strAttribute .= " <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"data" . $arrAttribute['name'] . "Allowance_$intRows\" value='t' checked></label></div></td>\n";
        }
        $strResult .= "<tr valign=top id='detailDataAllowance" . "_$intRows' style=\"display:none\">\n";
        $strResult .= "  <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"cbxAllow" . "_$intRows\" value='' ></label></div></td>\n";
        $strResult .= "  <td><input type=text name=dataSeqAllowance" . "_$intRows size=5 maxlength=40 disabled   class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataCodeAllowance" . "_$intRows size=20 maxlength=40 disabled  onChange=\"changeCode('Allowance',$intRows)\" class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataNameAllowance" . "_$intRows size=30 maxlength=40 disabled class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input class=form-control type=text name=dataAmountAllowance" . "_$intRows  size=20  disabled value=0></td>\n";
        $strResult .= $strAttribute;
        $strResult .= "<td class=center>&nbsp;</td>\n";
        $strResult .= "</tr>\n";
    }
...
function getDataDeduction($db)
{
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
        ...
        $strAttribute = "";
        foreach ($arrDeductionAttributes AS $arrAttribute) {
            // echo $rowDb[$arrAttribute['code']]."<br>";
            $strChecked = ($rowDb[$arrAttribute['code']] == 't') ? "checked" : "";
            $strAttribute .= " <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"data" . $arrAttribute['name'] . "Deduction_$intRows\" value='t' $strChecked></label></div></td>\n";
        }
        // die($strAttribute);
        $strResult .= "<tr valign=top id='detailDataDeduction" . "_$intRows'>\n";
        $strResult .= "  <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"cbxDeduc" . "_$intRows\" value='" . $rowDb['id'] . "' ></label></div></td>\n";
        ...
        $strResult .= "<input type=text name=dataCodeDeduction" . "_$intRows value=\"" . $rowDb['code'] . "\" size=20 maxlength=40 onChange=\"changeCode('Deduction',$intRows)\" class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataNameDeduction" . "_$intRows value=\"" . $rowDb['name'] . "\" size=30 maxlength=40 class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataAmountDeduction" . "_$intRows value=\"" . (float)$rowDb['amount'] . "\" size=20 maxlength=20 class='numeric form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataMaxlinkDeduction" . "_$intRows value=\"" . $rowDb['maxlink'] . "\" size=20 maxlength=20 class='string-empty form-control'></td>\n";
        $strResult .= $strAttribute;
        $strResult .= "<td class=center>&nbsp;</td>\n";
        $strResult .= "</tr>\n";
    }
    ...
    while ($intRows <= $intMaxDetail) {
        ...
        $strAttribute = "";
        foreach ($arrDeductionAttributes AS $arrAttribute) {
            $strAttribute .= " <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"data" . $arrAttribute['name'] . "Deduction_$intRows\" value='t' checked></label></div></td>\n";
        }
        $strResult .= "<tr valign=top id='detailDataDeduction" . "_$intRows' style=\"display:none\">\n";
        $strResult .= "  <td class=center><div class=\"checkbox\"><label><input type=checkbox name=\"cbxDeduc" . "_$intRows\" value='' ></label></div></td>\n";
        $strResult .= "  <td><input type=text name=dataSeqDeduction" . "_$intRows size=5 maxlength=40 disabled class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataCodeDeduction" . "_$intRows size=20 maxlength=40 disabled onChange=\"changeCode('Deduction',$intRows)\" class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataNameDeduction" . "_$intRows size=30 maxlength=40 disabled class='string-empty form-control'></td>\n";
        $strResult .= "  <td><input type=text name=dataAmountDeduction" . "_$intRows  size=20 maxlength=20 class='numeric form-control' disabled value=0></td>\n";
        $strResult .= "  <td><input type=text name=dataMaxlinkDeduction" . "_$intRows  size=20 maxlength=20 class='string-empty form-control' disabled value=0></td>\n";
        $strResult .= $strAttribute;
        $strResult .= "<td class=center>&nbsp;</td>\n";
        $strResult .= "</tr>\n";
    }
    ...
    for ($i = 1; $i <= $intMax; $i++) {
        ...
        if ($strCode == "") { // ada kemungkinan ndihapus
            ...
            if ($strID == "") { // insert new
                ...
                // AND template_name='$CurrentActiveTemplate'";
                $resExec = $db->execute($strSQL);
            }
        }
    }
...
{
    $strResult = "<select class=\"form-control select2\" id='loadTemplateName' name='loadTemplateName' >";
...
$strPageDesc = getWords('general salary setting page');
$pageHeader = pageHeader($pageIcon, $strPageTitle, $strPageDesc);
$pageSubMenu = salarySetSubmenu($strWordsGeneralSetting);
