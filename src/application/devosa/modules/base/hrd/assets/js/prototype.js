...
Ajax.modified_by = Class.create();

Object.extend(Object.extend(Ajax.modified_by.prototype, Ajax.Request.prototype), {
...
Ajax.Periodicalmodified_by = Class.create();
Ajax.Periodicalmodified_by.prototype = Object.extend(new Ajax.Base(), {
    initialize: function (container, url, options) {
        this.setOptions(options);
    ...
    stop: function () {
        this.modified_by.options.onComplete = undefined;
    ...
    onTimerEvent: function () {
        this.modified_by = new Ajax.modified_by(this.container, this.url, this.options);
    }
});
function $(element) {
