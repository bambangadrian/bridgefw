...
doInclude('libraries/classes/ga/apartment_request.php');
//================ END INCLUDE==========================================
...
function getData($db)
{
    ...
    if ($db->connect()) {
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("room"), "room_name", ['width' => '100'], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("Date To"), "date_to", ['width' => '150'], ['nowrap' => ''])
        );
