...
doInclude('../global/common_variable.php');
doInclude('libraries/helper/common_function.php');
doInclude('../global/date_function.php');
doInclude('../global/approval_function.php');
doInclude('../global/form_function.php');
doInclude('../global/words.php');
doInclude('../global/cls_permission.php');
...
if (isset($_REQUEST['dataCompany'])) {
    $intCAR = $_REQUEST['dataCompany'];
} else if (isset($_REQUEST['filterCompany'])) {
    $intCAR = $_REQUEST['filterCompany'];
} else if (isset($_SESSION['sessionCAR'])) {
    $intCAR = $_SESSION['sessionCAR'];
} else {
    $intCAR = -1;
}
