...
doInclude('libraries/classes/ga/item_edit.php');
//================ END INCLUDE=====================================
...
function getData($db)
{
    ...
    if ($db->connect()) {
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("Code"), "item_code", ['width' => '100'], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("Name"), "item_name", ['width' => '150'], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(new DataGrid_Column(getWords("unit"), "item_unit", ['width' => '50'], ['nowrap' => '']));
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("price"), "item_price", ['width' => '100'], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("stock"), "item_stock", ['width' => '40'], ['nowrap' => ''])
        );
        ...
        $myDataGrid->addColumn(
            new DataGrid_Column(getWords("Rooms"), "room_name", ['width' => '100'], ['nowrap' => ''])
        );
        $myDataGrid->addColumn(
