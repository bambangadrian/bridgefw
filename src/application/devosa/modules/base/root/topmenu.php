...
//doInclude('includes/krumo/class.krumo.php');
//krumo($_SESSION);
...
<div class="navbar navbar-default navbar-static-top navbar-main" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="main.php">
            &nbsp;<img src="<?= $GLOBALS['globalRelativeFolder'] ?>images/logo_front_new_deluxe.png"
                       height="48"
    ...
    <ul id="main-module" class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle avatar pull-right" data-toggle="dropdown">
                ...
                <span class="hidden-small"><?php print ucfirst($_SESSION['sessionUserName']); ?>
