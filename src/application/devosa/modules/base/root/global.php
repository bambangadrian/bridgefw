...
doInclude('includes/dbclass/dbclass.php');
doInclude('includes/tbsclass/tbs_class.php');
doInclude('includes/tbs-3.7.0/tbs_class.php');
doInclude('global/words.php');
doInclude('global/helps.php');
doInclude('includes/model/model.php');
