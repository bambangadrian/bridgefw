...
doInclude('includes/menu/clsMenu.php');
$menu = new clsMenu(
...
<div class="navbar navbar-default navbar-static-top navbar-main" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand"
           href="index.html"><img src="<?= $GLOBALS['globalRelativeFolder'] ?>images/logo_front.gif"
                                  width="100"></a>
    </div>
    <ul class="nav navbar-nav navbar-right">
            ...
            <ul class="dropdown-menu pull-right">
                ...
                <li>
                    <a href="#">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor et dolore magna
                           aliqua.</p>
                    </a>
                </li>
                <li class="open-section">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle avatar pull-right" data-toggle="dropdown">
                <img src="[var.globalRelativeFolder]asset/img/users/mike.jpg" alt="mike" class="img-avatar" />
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <div style='height: 46px'>
                ...
                $link = [
                    ...
                    ["url" => "help.php", "name" => strtoupper(getWords("help")), "faicon" => "fa-info-circle"],
