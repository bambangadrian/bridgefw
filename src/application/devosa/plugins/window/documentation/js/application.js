var Application = {
    ...
    evalCode: function (id) {
        ...
        try {
            ...
            Dialog.alert(" error accurs while interprating your javascript code <br/>" + error, {
                windowParameters: {
                    width: 300,
    ...
    insertDocOverview: function () {
        ...
        $$(".window").each(function (element) {
            html += "- <a href='#" + element.title + "'>" + element.title + "</a><br/>"
        });
        html += "</ul></td>";

        // Dialog
        html += "<td>Dialog Module <ul>";
        $$(".dialogmodule").each(function (element) {
            html += "- <a href='#" + element.title + "'>" + element.title + "</a><br/>"
        });
        html += "</ul></td>";
