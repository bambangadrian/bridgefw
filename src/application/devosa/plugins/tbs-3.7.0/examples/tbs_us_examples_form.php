...
if (!isset($_POST['x_type'])) {
    ...
    if (($msg_err === '') && (trim($x_type) == '-')) {
        $msg_err = 'Please enter your gender.';
    }
    if (($msg_err === '') && (trim($x_name) == '')) {
        $msg_err = 'Please enter your name.';
    }
    if (($msg_err === '') && (trim($x_subname) == '')) {
        $msg_err = 'Please enter your subname.';
    }
    if ($msg_err === '') {
        $msg_ok = 'Thank you.';
    }
