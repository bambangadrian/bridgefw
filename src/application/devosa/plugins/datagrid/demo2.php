...
$myDataGrid->addColumn(
    new DataGrid_Column(
        "Attendance", "", ['colspan' => '3'], ['nowrap' => ''], false, false, "", "", "string", true, 20
    )
);
$myDataGrid->addColumn(
    new DataGrid_Column(
...
$myDataGrid->addColumn(
    new DataGrid_Column("xxx", "id", null, ['nowrap' => ''], false, false, "", "", "string", true, 20)
);
$myDataGrid->addColumn(
    new DataGrid_Column("xxx", "note", ['rowspan' => 2], ['nowrap' => ''], false, false, "", "", "string", true, 20)
);
