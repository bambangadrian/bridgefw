                        ...
                        if ($obj['dataType'] == "time") {
                            ...
                            if ($obj['type'] == 'autocomplete') {
                                ...
                                if ($obj['dataType'] == "date") {
                                    $strResult = $obj['htmlBefore'] . "<div class=\"input-group\"><input $required class=\"form-control datepicker\" data-date-format=\"yyyy-mm-dd\" type=\"" . $obj['type'] . "\" id=\"" . $obj['name'] . "\" name=\"" . $obj['name'] . "\" ";
                                } else {
