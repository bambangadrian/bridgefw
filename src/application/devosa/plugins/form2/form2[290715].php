...
class clsForm
{
    ...
    function _printObject($obj)
    {
            ...
            case 'textarea':
                if ($obj['visible']) {
                    if ($this->readonly) {
                        ...
                        $strResult = $obj['htmlBefore'] . "<div class=\"col-sm-8\"><textarea class=form-control id=\"" . $obj['name'] . "\" name=\"" . $obj['name'] . "\" ";
                    ...
                    if ($this->readonly) {
                        ...
                        if ($obj['dataType'] == "time") {
                            ...
                            if ($obj['type'] == 'autocomplete') {
                                $strResult = $obj['htmlBefore'] . "<div class=\"col-sm-8\"><input class=form-control type=\"text\" id=\"" . $obj['name'] . "\" name=\"" . $obj['name'] . "\" ";
                                ...
                                $strResult = $obj['htmlBefore'] . "<div class=\"col-sm-8\"><input class=form-control type=\"" . $obj['type'] . "\" id=\"" . $obj['name'] . "\" name=\"" . $obj['name'] . "\" ";
                            }
                            if (!$this->resetData) {
        ...
        if ($obj['required']) {
            ...
            $strResult .= '<div class="col-sm-4">' . $this->_printSpan(
                    "",
                    "&nbsp;*",
                    ["class" => "required"],
                    "&nbsp;" . $obj['htmlAfter'],
    ...
    function _printObjectGroup($tabPageNumber, $groupNumber)
    {
      ...
      $strResult .= "
            ...
            ($j < ($i + 1) * $jmlBaris && $j < count($this->formObject[$tabPageNumber][$groupNumber])); $j++
                ...
                $strResult .= "<div class=\"col-md-6\"><div class=\"form-group\">";
                if (!($this->formObject[$tabPageNumber][$groupNumber][$j]['renderLabel'])) {
                    ...
                    $strResult .= "<div class=\"col-sm-8\"
                  " . $this->_printObject($this->formObject[$tabPageNumber][$groupNumber][$j]) . "
                  </div>
                </div>";
                } else {
                    if (count($this->formObject[$tabPageNumber][$groupNumber][$j]['labelAttribute']) > 0) {
                        ...
                        */
                        $strResult .= "
                    <label for=\"label\" class=\"col-sm-3 control-label\">" . $this->_printObjectCaption(
    ...
    function _printObjectList()
    {
        ...
        if ($this->hasButton) {
            ...
            $strResult .= "<div class=\"col-md-12\"><div class=\"col-md-6\"><div class=\"col-md-3\"></div><div class=\"col-md-9\">";
        ...
        {
            $strResult .= "<div class=\"col-md-12\"><div class=\"col-md-6\"><div class=\"col-md-3\"></div><div class=\"col-md-9\">
      <span class='requiredSmall'>* " . $GLOBALS['FORMWORDS']['required field'] . "</span></div></div></div>";
        }
        //$strResult .= "</table>";
        if ($this->hasTabPage) {
            $strResult .= "</div>";
        ...
        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
          <tr>";
            ...
            <td class=\"minimize\" onClick=\"javascript:my" . $this->formName . ".doMinimize(this)\" onMouseOver=\"this.className=this.className+'Hover'\" onMouseOut=\"this.className=this.className.replace('Hover', '')\">&nbsp;</td>";
                $strResultAction .= "<div class=\"panel-actions\"> <a href=\"javascript:my" . $this->formName . ".doMinimize(this)\" onMouseOver=\"this.className=this.className+'Hover'\" onMouseOut=\"this.className=this.className.replace('Hover', '')\"><i class=\"fa fa-eye\"></i></a></div>";
            }
...
";
  ...
  <script type=\"text/javascript\" src=\"" . $GLOBALS['CLASSFORMPATH'] . "scripts/form_ac.js" . "\"></script>";
        ...
        $strResult .= "<div class=\"panel\" id=\"table_" . $this->formName . "\" style=\"display: none\">";
        ...
        <tr valign=\"top\" id=\"row_".$this->formName."\">
          ...
          */
        $strResult .= "<div class=\"panel-body\" id=\"row_" . $this->formName . "\">
                    <div class=\"col-md-12\" id=\"content_" . $this->formName . "\">";
