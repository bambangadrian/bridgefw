var displayed = "<button type=\"button\" class=\"btn btn-primary\" onclick=\"window.scrollTo(0,0)\"><i class=\"fa fa-level-up\"></i> top</button>";
...
function staticit() {
    ...
    var w2 = ns6 ? pageXOffset + object_scroll_width + 30 : document.body.scrollLeft + object_scroll_width;
    var h2 = ns6 ? pageYOffset + object_scroll_height - 10 : document.body.scrollTop + object_scroll_height;
